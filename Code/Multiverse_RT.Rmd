...
calculate_meta <- function(RT=FALSE, ACC=FALSE, plot=TRUE, multilevel=FALSE) {
    ...
    print(I2$results)
        ...
        if(plot) {
            # Assuming transform_functions.r is correctly sourced and available
            source("transform_functions.r")

            # Ensure I2 calculation function and plotting functions are available
        ...
        # Ensure the 'metafor' package is loaded
        library(metafor)
