...
```{r}
multilevel_meta <- function(data, effect_size_col,variance_col, id_col) {
  ...
  # Dynamically create the formula for random effects
  ...
  # Return the model
  print("updated heterogeneity in %: (ignore model heterogenetiy!)")
  print(I2)
  return(model)
