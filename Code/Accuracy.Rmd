...
#, cache = TRUE}
predictors <- c("DoseLabel", "dosage_cat_all", "EF_sensitivity", "CognitiveFunction") # adjust based on previous analysis
...
# data_p <- data.frame(
#   "studlab" = data_p$PlotLabel,
#   "TE" = data_p$ES_final_RT,
#   "seTE" = sqrt(data_p$ES_var_RT)
# )

# # Run the p-curve analysis
# pcurve_result <- pcurve(data_p)
