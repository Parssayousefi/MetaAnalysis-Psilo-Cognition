...
```
```{r Figure 4 Funnel plot Function, fig.width = 10, fig.height = 15,  out.width="100%"}
...
funnel_plot <- function(RT = FALSE, ACC = FALSE) {
    ...
    par(mfrow = c(1, 1), tck = -.03, mgp = c(6, 3, 0), mar = c(8, 10, 5, 6), bg = "white",
        ...
        cex.lab = 10,  # Font size for the axis titles
    ...
    png(filename = file_path, width = 2500, height = 3000, res = 300)
    ...
    legend("topright", ncol = 1,inset = c(0, 0.32),
    ...
    legend("topright", inset = c(0, 0.41),
...
forest_plot <- function(RT = FALSE, ACC = FALSE) {
  ...
  png(filename = file_path, width = 2800, height = 2200, res = 300)
  plot(p)
  dev.off()
